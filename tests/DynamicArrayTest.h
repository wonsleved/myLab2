#ifndef MYLAB2_DYNAMICARRAYTEST_H
#define MYLAB2_DYNAMICARRAYTEST_H

void DynamicArrayTestInt() {
    int* testArr = new int[5] {1, 2, 3, 4, 5};
    DynamicArray<int> test1(testArr, 5);
    ...
    assert( test1.setItem(1, 10).getItem(1) == 10);
    assert( test1.setItem(2, 30).getItem(2) == 30);
    assert( test1.setItem(1, 9).getItem(1) == 9);
    assert( test1.setItem(3, 13).getItem(3) == 13);

    assert( test1.push(11).getLast() == 11 );
    assert( test1.pop().getLast() != 11 );
    assert( test2.unshift(11).getFirst() == 11 );
...
void DynamicArrayTestDouble() {
    ...
    DynamicArray<double> test1(testArr, 5);
    ...
    assert( test1.setItem(1, 10.1).getItem(1) == 10.1);
    assert( test1.setItem(2, 30.1).getItem(2) == 30.1);
    assert( test1.setItem(1, 9.1).getItem(1) == 9.1);
    assert( test1.setItem(3, 13.1).getItem(3) == 13.1);

    assert( test1.push(11.1).getLast() == 11.1 );
    assert( test1.pop().getLast() != 11.1 );
    assert( test2.unshift(11.1).getFirst() == 11.1 );
...
void DynamicArrayTestComplex() {
    ...
    DynamicArray<std::complex<int>> test1(testArr, 5);
    DynamicArray<std::complex<int>> test2(test1);
    ...
    assert( test2.unshift( (2, 1) ).getFirst() == (11, 1) );
